...
public Boolean add(int a){return answer.add(a);}

public Boolean hasNext(){return index<answer.size();}
public int next(){if(index<answer.size()){return answer.get(index++);}else
{return -1;}
}
//重置答案数据集中索引的序号
...
public void set(int index,int x){ answer.set(index, x);}
}
